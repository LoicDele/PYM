...
export class SemagViewComponent implements OnInit {
  ...
  zoom(id:string): void{
    ...
    var zoom_pos_beta = new BABYLON.Animation("zoomposbeta", "beta", 20, BABYLON.Animation.ANIMATIONTYPE_FLOAT, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    ...
    var zoom_pos_radius = new BABYLON.Animation("zoomposradius", "radius", 20, BABYLON.Animation.ANIMATIONTYPE_FLOAT, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    ...
    this._scene.beginDirectAnimation(this._camera, [zoom_cam, zoom_pos_beta, zoom_pos_radius], 0, 1*20, false);
  }

  dezoom(): void{
    var dezoom_cam = new BABYLON.Animation("dezoom", "target", 20, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    var dezoom_cam_keys = [];
    ...
    var pos_cam = new BABYLON.Animation("pos", "position", 20, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    var pos_cam_keys = [];
    pos_cam_keys.push({
      frame: 0,
      value: this._camera.position
    ...
    this._scene.beginDirectAnimation(this._camera, [dezoom_cam, pos_cam], 0, 1*20, false);
  }
}
